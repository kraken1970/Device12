...
(function () {
  var wrapCheck = document.querySelectorAll(".btn-wrap-checkbox");
  var btnCheck = document.querySelectorAll(".checkbox-resise");
  var servises = document.querySelectorAll(".service-content--item");
...
(function () {
  ...
  var openWriteUs = document.querySelector(".write-to-us");
  var closeWriteUs = writeUs.querySelector(".modal-close");
  var overLay = document.querySelector(".modal-overlay");
  var formWriteUs = document.querySelector(".form-write-us");
  var inputName = formWriteUs.querySelector(".name");
  var inputMail = formWriteUs.querySelector(".mail");
  ...
  var mapDevice = document.querySelector(".modal-map");
  var openMap = document.querySelector(".contact-map");
  var closeMap = mapDevice.querySelector(".modal-close");

  openMap.onclick = function (o) {
    o.preventDefault();
    mapDevice.style.display = "block";
    overLay.style.display = "block";
  };

  closeMap.onclick = function (o) {
    o.preventDefault();
